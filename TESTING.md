...
| Delete other user post (defensive)  | Manually enter `/posts/<id>/delete/` for another user’s post     | Action denied (403/blocked); post remains                                |           | ![screenshot](documentation/manual-testing/delete-other-user.png) |
...
| Edit other user comment (defensive) | Manually enter `/comments/<id>/edit/` for another user’s comment | Access denied (404/403); comment not changed                             |           | ![screenshot](documentation/manual-testing/edit-other-user.png) |
