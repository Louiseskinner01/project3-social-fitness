...
| Like/unlike post                           | Click like button on a post and Prevent duplicate likes (defensive)                                      | Like is created; heart state/like count updates. Click the heart button again and the like count is removed. Only one like per user per post (no duplicates) using toggle function                         |   ✅ Works            | ![screenshot](documentation/manual-testing/like-unlike1.png) <br> ![screenshot](documentation/manual-testing/like-unlike2.png)|
