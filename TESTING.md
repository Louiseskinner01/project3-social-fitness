...
| Edit own comment                    | Edit a comment created by logged-in user                         | Updated comment saves and displays correctly                             |           | **Before**![screenshot](documentation/manual-testing/edit-comment1.png)<br> **Comment being edited** ![screenshot](documentation/manual-testing/edit-comment2.png)<br> **Comment after edit** ![screenshot](documentation/manual-testing/edit-comment3.png) |
